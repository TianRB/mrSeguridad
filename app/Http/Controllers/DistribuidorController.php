...
class DistribuidorController extends Controller
{
	...
	public function distribuidorPerfil()
	{
			return view('backend.distribuidores.perfil');
	}
	public function distribuidorFacturas()
	{
			return view('backend.distribuidores.facturas');
	}
	public function distribuidorPedidos()
	{
			return view('backend.distribuidores.pedidos');
	}
}
